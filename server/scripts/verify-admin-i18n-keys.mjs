...
const required = [
  ...
  'menu.groups.partners',
  'menu.groups.insights',
  'menu.staff',
  'menu.statistics',
  'staff.title',
  'staff.perm.dashboard',
  'brandingPage.logoTitle',
  'domainsPage.title',
  'generalPage.profileTitle',
  'reportsUi.reservationsTitle',
  'calendar.viewAria',
  'maintenance.tabsAria',
  'employees.title',
  'chauffeurs.title',
  'samsars.title',
