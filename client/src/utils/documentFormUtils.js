...
export const initContractForm = (doc) => {
  ...
  return {
    ...
    vehicleFuel: pickValue(s.vehicleFuel, car.fuel_type, car.fuelType, v.car_fuel, v.carFuel),
    vehicleTransmission: pickValue(s.vehicleTransmission, car.transmission, car.gearbox, v.car_transmission, v.carTransmission),
    brokerReferrer: pickValue(s.brokerReferrer, b.brokerReferrer, v.broker_referrer, v.brokerReferrer),
    vehicleDeliveryDriver: pickValue(s.vehicleDeliveryDriver, b.vehicleDeliveryDriver, v.vehicle_delivery_driver, v.vehicleDeliveryDriver),
...
export const buildContractPatch = (form) => ({
  ...
  brokerReferrer: form.brokerReferrer,
  vehicleDeliveryDriver: form.vehicleDeliveryDriver,
