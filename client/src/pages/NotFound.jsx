  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center page-pad text-center py-16">
      <Seo
        ...
        description="This Americonfort page does not exist. Browse available cars or return home."
        path="/404"
        noindex
      />
      ...
      <div className="mt-8 flex flex-col sm:flex-row gap-3 w-full sm:w-auto max-w-xs sm:max-w-none">
        ...
        <Link
          ...
          className="px-5 py-2.5 rounded-lg border border-borderColor text-gray-700 hover:bg-gray-50 text-center"
        >
          Airport rental
        </Link>
      </div>
