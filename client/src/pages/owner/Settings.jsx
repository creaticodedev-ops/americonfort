...
const Settings = () => {
  ...
  return (
    <div className="px-4 pt-8 md:px-8 lg:px-10 xl:px-12 md:pt-10 flex-1 pb-12 min-w-0 space-y-6">
      ...
      {/* Agency stamp / document defaults */}
      <section
        id="document-settings"
        className="max-w-3xl rounded-2xl border border-borderColor bg-white p-5 sm:p-6 space-y-5"
      >
        <div>
      ...
      {/* Booking Settings — primary owner configuration surface */}
      <section
        id="booking-settings"
