...
export const navIconForPath = (path) => {
  ...
  if (path.includes('car') || path.includes('maintenance')) return 'car'
  if (path.includes('locations')) return 'car'
  if (path.includes('staff') || path.includes('chauffeur') || path.includes('customer') || path.includes('samsar') || path.includes('employee')) return 'users'
  ...
  if (path.includes('branding')) return 'settings'
